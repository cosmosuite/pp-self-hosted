export interface BlurOptions {
  ...
  // SafeVision blur rule properties
  blurFemaleGenitaliaExposed?: boolean;
  blurMaleGenitaliaExposed?: boolean;
  blurButtocksExposed?: boolean;
  blurFemaleBreastExposed?: boolean;
  blurAnus?: boolean;
  blurFemaleGenitaliaCovered?: boolean;
  blurMaleGenitaliaCovered?: boolean;
  blurFemaleBreastCovered?: boolean;
  blurMaleChest?: boolean;
  blurBelly?: boolean;
  blurFeet?: boolean;
  blurArms?: boolean;
  blurFace?: boolean;
  blurWearingMask?: boolean;
  blurWearingHelmet?: boolean;
  blurGlasses?: boolean;
  blurHair?: boolean;
  blurMaleFace?: boolean;
}
